    ...
    <View style={styles.wrapper}>
      ...
      <View style={styles.price}>
        <Text style={styles.priceText}>
          <Text style={{fontWeight: '700'}}>{product.price}0 руб</Text> за 1 шт
        </Text>
      ...
      <View style={styles.productDesctiption}>
        ...
        <Text style={styles.productDesctiptionText}>
          Вес одной порции : 38гр
        </Text>
        <Text style={styles.productDesctiptionText}>
          Пищевая ценность на 100 г:
        </Text>
        <View style={styles.productCharacteristic}>
          <Text style={styles.productDesctiptionText}>Энерг. ценность</Text>
          <Text style={styles.productDesctiptionText}>164.10 ккал</Text>
        </View>
        <View style={styles.productCharacteristic}>
          <Text style={styles.productDesctiptionText}>Белки</Text>
          <Text style={styles.productDesctiptionText}>10.80 г</Text>
        </View>
        <View style={styles.productCharacteristic}>
          <Text style={styles.productDesctiptionText}>Жиры</Text>
          <Text style={styles.productDesctiptionText}>2.50 г</Text>
        </View>
        <View style={styles.productCharacteristic}>
          <Text style={styles.productDesctiptionText}>Углеводы</Text>
          <Text style={styles.productDesctiptionText}>24.20 г</Text>
        </View>
      </View>
    </View>
  );
