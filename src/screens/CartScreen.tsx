...
export const CartScreen = ({route, navigation}: any) => {
  ...
  const sendOrder = () => {
    Alert.alert('Заказ', 'Ваш заказ был успешно отправлен', [
      {
        text: 'OK',
        onPress: () => {
          setCart([]);
      ...
      <ScrollView style={styles.cartItems}>
        {cartLocal.length >= 1 ? (
            ...
            return (
              <View style={styles.cartItem} key={index}>
                <View style={styles.cartItemTop}>
                  ...
                  <Text style={styles.itemTitle}>{item.price}0 руб.</Text>
                </View>
          ...
          <View style={styles.cartEmpty}>
            <View>
              <Text style={styles.cartEmptyTitle}>Ваша корзина пуста</Text>
